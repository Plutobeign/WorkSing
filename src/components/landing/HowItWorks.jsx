...
const steps = [
  ...
  { Icon: MonitorPlay, title: 'Sing while you work',  desc: 'A translucent overlay shows lyrics on top of your browser. Minimal, unobtrusive, fun.' },
]
...
const s = {
  ...
  h2: { fontSize: 'clamp(28px,4vw,40px)', fontWeight: 700, textAlign: 'center', marginBottom: 64, fontFamily: "'Inter',sans-serif", color: '#fff', letterSpacing: '-0.02em' },
